...
def cal_selfsupervised_loss(outs, args, lambda_drloc=0.0):
    ...
    if args.drloss:
        if args.DRLOC_MODE == "l1": # l1 regression constraint
            reld_criterion = relative_constraint_l1 
        elif args.DRLOC_MODE == "ce": # cross entropy constraint
            reld_criterion = relative_constraint_ce
        elif args.DRLOC_MODE == "cbr": # cycle-back regression constaint: https://arxiv.org/pdf/1904.07846.pdf
