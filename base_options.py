...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--lr_mlp', type=float, default=1e-4, metavar='LR',
							help='learning rate (default: 3e-4)')
		self.parser.add_argument('--lr_loss', type=float, default=0.001, metavar='LR',
							help='learning rate (default: 3e-4)')
		...
		self.parser.add_argument(
			"--model_save_dir", type=str, default='exps/debug/models/', help="model save dir")
		self.parser.add_argument(
		...
		self.parser.add_argument(
			'--drloss', type=int, default='1', help='run tsne or not')
		self.parser.add_argument(
			'--DRLOC_MODE', type=str, default='ce', help='weight and bias setup')
		### for transformer ###
		self.parser.add_argument(
		...
		### for AV-ada ###
		self.parser.add_argument('--train_audio_folder', type=str, default="/data/yanbo/Dataset/AVE_Dataset/raw_audio", help="raw audio path")
		self.parser.add_argument('--train_video_folder', type=str, default="/data/yanbo/Dataset/AVE_Dataset/video_frames", help="video frame path")
		...
		### Voxceleb 
		self.parser.add_argument('--train_list', type=str,   default="/data08/VoxCeleb2/train_all.txt",     help='The path of the training list')
		self.parser.add_argument('--train_path', type=str,   default="/data08/VoxCeleb2/",                  help='The path of the training data')
		self.parser.add_argument('--eval_trials',type=str,   default="/data08/VoxCeleb1/O_trials.txt",      help='The path of the evaluation trials, https://www.robots.ox.ac.uk/~vgg/data/voxceleb/meta/veri_test2.txt')
		self.parser.add_argument('--eval_list',  type=str,   default="/data08/VoxCeleb1/O_list.txt",        help='The path of the evaluation list, contains all evaluation data info')
		self.parser.add_argument('--eval_path',  type=str,   default="/data08/VoxCeleb1/",                  help='The path of the evaluation data')
		self.parser.add_argument('--n_class',    type=int,   default=5994,     help='Number of speakers')
		self.parser.add_argument('--margin_a',       type=float, default=0.2,    help='Loss margin for audio training')
		self.parser.add_argument('--scale_a',        type=float, default=30,     help='Loss scale for audio training')
		self.parser.add_argument('--musan_path',   type=str, default="/misc/scratch02/reco/Corpora/VoxCeleb_August2021/musan_split/")
		self.parser.add_argument('--rir_path',     type=str, default="/misc/scratch02/reco/Corpora/VoxCeleb_August2021/RIRS_NOISES/simulated_rirs/")
		self.parser.add_argument('--num_eval_frames', type=int,   default=5,       help='Number of eval frames, higher will be better')
		self.parser.add_argument('--save_path',  type=str,    default="", help='Path to save the clean list')
		self.parser.add_argument('--max_epoch',  type=int,   default=200,      help='Maximum number of epochs')
		self.parser.add_argument('--test_step',  type=int,   default=1,        help='Test and save every [test_step] epochs')
